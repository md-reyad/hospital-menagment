            ...
            <div class="dropdown-menu float-left">
                <div class="box-sm">
                    ...
                    <div class="pad5A button-pane button-pane-alt text-center">
                        ...
                        ?>
                        <a href="?admin=logout&logout=true" class="btn display-block font-normal btn-danger">
                        ...
                        ?>
                        <a href="?status=logout&logout=true" class="btn display-block font-normal btn-danger">
                            <i class="glyph-icon icon-power-off"></i>
                            Logout
                        </a>
                        <?php
