...
$admin_obj = new admin_function();
$session_id = $_SESSION['id'];
$typeee = $_SESSION['type'];
//if (!$session_id && $typeee==0) {
//    header("location: index.php");
//}
//if (!$session_id && $typeee==1) {
//    header("location: ../index.php");
//}
if (isset($_GET['admin']) == TRUE) {
    $admin_obj->logout_admin();
}
                ...
                <div id="page-content">
                    ...
                    if (isset($pages)) {
                        if ($pages == 'add_category') {
                            include './contant/add_category_contant.php';
                        } elseif ($pages == 'view_category') {
                            include './contant/view_category_contant.php';
                        } elseif ($pages == 'view_doctor') {
                            include './contant/view_doctor_contant.php';
                        } elseif ($pages == 'add_doctor') {
                            include './contant/add_doctor_contant.php';
                        } elseif ($pages == 'edit_doctor') {
                            include './contant/doctor_edit_contant.php';
                        } elseif ($pages == 'slider') {
                            include './contant/add_slider_contant.php';
                        } elseif ($pages == 'footer') {
                            include './contant/add_footer_contant.php';
                        } elseif ($pages == 'add_serial') {
                            include './contant/add_serial_contant.php';
                        } elseif ($pages == 'view_serial') {
                            include './contant/view_serial_contant.php';
                        } elseif ($pages == 'serial_admin') {
                            include './contant/view_serial_contant_admin.php';
                        } elseif ($pages == 'add_contact') {
                            include './contant/add_contact_contant.php';
                        } elseif ($pages == 'view_contact') {
                            include './contant/view_contact_contant.php';
                        } elseif ($pages == 'edit_serial') {
...
<!-- Mirrored from agileui.com/demo/monarch/demo/admin-template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jul 2016 17:31:03 GMT -->
</html>