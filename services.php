...
<!-- Mirrored from markup.themewagon.com/healthcare_pro/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jul 2016 17:54:37 GMT -->
<head>
		<meta charset="UTF-8">
		<meta http-equiv="X-UA-Compatible" content="IE=edge">
	    <meta name="viewport" content="width=device-width, initial-scale=1">
		<link rel="shortcut icon" href="img/season-change.html" type="image/x-icon">
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-4 service">
	        			...
	        			<div class="row text-center">
	        				<div class="about-service">
		        				<h3 class="text-center">Diagnostic Imaging</h3>
		        				<p class="text-center">
	        		...
	        		<div class="col-sm-4 service">
	        			...
	        			<div class="row text-center">
	        				<div class="about-service">
		        				<h3 class="text-center">Cancer Care</h3>
		        				<p class="text-center">
		        					Adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
		        				</p>
		        				<a href="#" class="service-rm-btn btn btn-primary">
	        		...
	        		<div class="col-sm-4 service">
	        			...
	        			<div class="row text-center">
	        				<div class="about-service">
		        				<h3 class="text-center">Rehabilitation Center</h3>
		        				<p class="text-center">
		        					Adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud 
		        				</p>
		        				<a href="#" class="service-rm-btn btn btn-primary">
	        		...
	        		<div class="col-sm-4 service">
	        			...
	        			<div class="row text-center">
	        				<div class="about-service">
		        				<h3 class="text-center">Emergency Services</h3>
		        				<p class="text-center">
		        					Adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud 
		        				</p>
		        				<a href="#" class="service-rm-btn btn btn-primary">
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class= "appointment special-service-apointment">
							...
							<!-- form of appointment -->
							<div class="row">
								<form id="appointment_form" method="post" action="http://markup.themewagon.com/healthcare_pro/php/appointment_form.php">
										<div class= "form">
										...
										<div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-10 col-xs-offset-1">
											...
											<button class="btn btn-primary send send-services" id="afsubmit" name="submit" type="submit">Send</button>
										</div>
									</form>
							</div>
							<!-- end of form -->
...
<!-- Mirrored from markup.themewagon.com/healthcare_pro/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jul 2016 17:55:01 GMT -->
</html>
