...
?>
    ...
    <body>
                ...
                <div cl ass="container">
                    ...
                    <div class="row">
                        <div class="sub-headline">
                            <span><a href="index.php" style="color:rgb(180,181,183)">Home</a>/Doctors</span>
                        </div>
                    </div>	
                </div>
            </div>
        ...
        <div class="col-sm-3 col-sm-offset-9">
            <?php
            if(isset($_POST['btn'])){
              $index_objjs->search_data($_POST);
            }
            ?>
            <form action="search.php" method="get">
                <input type="search" name="search" class="form-control form-inline">
            <button class="btn" name="btn" type="submit">Search</button>
            </form>
        </div>
